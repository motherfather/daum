...
<body>
			...
			<div class="navbar navbar-default navbar-fixed-top" role="navigation"
				...
				<div class="container">
					<div class="navbar-header">
						<!-- Logo Starts -->
						<a class="navbar-brand" href="http://www.naver.com"><img id="logo"
	...
	<div id="works" class=" clearfix grid">
			...
			<figcaption>
				...
				<p>
					Lily likes to play with crayons and pencils<br> <a
						href="assets/images/portfolio/1.jpg" title="1" data-gallery>View
						more</a>
				</p>
			</figcaption>
		</figure>
		<figure class="effect-oscar  wowload fadeInUp">
			...
			<figcaption>
				...
				<p>
					Lily likes to play with crayons and pencils<br> <a
						href="assets/images/portfolio/2.jpg" title="1" data-gallery>View
						more</a>
				</p>
			</figcaption>
		</figure>
		<figure class="effect-oscar  wowload fadeInUp">
			...
			<figcaption>
				...
				<p>
					Lily likes to play with crayons and pencils<br> <a
						href="assets/images/portfolio/3.jpg" title="1" data-gallery>View
						more</a>
				</p>
			</figcaption>
		</figure>
		<figure class="effect-oscar  wowload fadeInUp">
			...
			<figcaption>
				...
				<p>
					Lily likes to play with crayons and pencils<br> <a
						href="assets/images/portfolio/4.jpg" title="1" data-gallery>View
						more</a>
				</p>
			</figcaption>
		</figure>
		<figure class="effect-oscar  wowload fadeInUp">
			...
			<figcaption>
				...
				<p>
					Lily likes to play with crayons and pencils<br> <a
						href="assets/images/portfolio/5.jpg" title="1" data-gallery>View
						more</a>
				</p>
			</figcaption>
		</figure>
		...
		<figure class="effect-oscar  wowload fadeInUp">
			<img src="assets/images/portfolio/7.jpg" alt="img01" />
			<figcaption>
				<h2>Chinese</h2>
				<p>
					Lily likes to play with crayons and pencils<br> <a
						href="assets/images/portfolio/7.jpg" title="1" data-gallery>View
						more</a>
				</p>
			</figcaption>
		</figure>
		<figure class="effect-oscar  wowload fadeInUp">
			<img src="assets/images/portfolio/8.jpg" alt="img01" />
			<figcaption>
				<h2>Dicrap</h2>
				<p>
					Lily likes to play with crayons and pencils<br> <a
						href="assets/images/portfolio/8.jpg" title="1" data-gallery>View
						more</a>
				</p>
			</figcaption>
		</figure>
		<figure class="effect-oscar  wowload fadeInUp">
			<img src="assets/images/portfolio/9.jpg" alt="img01" />
			<figcaption>
				<h2>Coffee</h2>
				<p>
					Lily likes to play with crayons and pencils<br> <a
						href="assets/images/portfolio/9.jpg" title="1" data-gallery>View
						more</a>
				</p>
			</figcaption>
		</figure>
	...
	<div class="container" id="guestbook">
		<ul class="nav nav-tabs">
			<li class="active"><a data-toggle="tab" href="#list">방명록</a></li>
			<li><a data-toggle="tab" href="#write">글쓰기</a></li>
		</ul>
	...
	<div id="partners" class="container spacer ">
		...
		<div class="clearfix">
			<div class="col-sm-6 partners  wowload fadeInLeft">
				<img src="assets/images/partners/1.jpg" alt="partners"> <img
					src="assets/images/partners/2.jpg" alt="partners"> <img
					src="assets/images/partners/3.jpg" alt="partners"> <img
					src="assets/images/partners/4.jpg" alt="partners">
			</div>
			<div class="col-sm-6">
					...
					<div class="carousel-inner">
						<div class="item active animated bounceInRight row">
							<div class="animated slideInLeft col-xs-2">
								<img alt="portfolio" src="assets/images/team/1.jpg" width="100"
						...
						<div class="item  animated bounceInRight row">
							<div class="animated slideInLeft col-xs-2">
								<img alt="portfolio" src="assets/images/team/2.jpg" width="100"
									class="img-circle img-responsive">
							</div>
							<div class="col-xs-10">
						...
						<div class="item  animated bounceInRight row">
							<div class="animated slideInLeft  col-xs-2">
								<img alt="portfolio" src="assets/images/team/3.jpg" width="100"
									class="img-circle img-responsive">
							</div>
							<div class="col-xs-10">
		...
		<div class="row grid team  wowload fadeInUpBig">
			<div class=" col-sm-3 col-xs-6">
				<figure class="effect-chico">
					<img src="assets/images/team/8.jpg" alt="img01"
	...
	<div class="footer text-center spacer">
		...
		Copyright 2016 Daum. All rights reserved.
	</div>
	<!-- # Footer Ends -->
